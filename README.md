...
Este quickstart guia você pela criação de um cluster **k3s multi-nó** com service mesh **Istio**,
autenticação via **JWT** e políticas de segurança baseadas em identidade de serviço
...
|-----------|-------------|--------------|----------------------------------------------------------------------------------------------------------------------|
| service-1 | `service-1` | LoadBalancer | Permite apenas requests com JWTs válidos.                                                                            |
| service-2 | `service-2` | ClusterIP    | Permite apenas mTLS do `service-1` via `source.principals`                                                           |
| service-3 | `service-3` | LoadBalancer | Bloqueia o tráfego dos outros serviços, mas permite tráfego externo com JWT válido.                                  |
...
Nessa etapa o Vagrant se encarrega de subir as máquinas virtuais no VirtualBox e instalar o k3s
nelas.
